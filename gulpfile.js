...
var containers = function(tag){
    return {
        ...
        django : {
            dockerfile : '../Django/',
            env: { 'FOCALCAST_DEPLOYMENT' : 'settings.'+tag},
            tags : cc(tag),
            name : 'django',
            directory : '../Django/',
            repo : 'focalcast/django'
        },
        angular : {
            dockerfile: '../Angular/static',
            tags : cc(tag),
            name : 'angular',
            directory : '../Angular/static/',
            repo : 'focalcast/angular'
        },
        nginx : {
            dockerfile: '../Nginx/',
            tags : cc(tag),
...
var pushToAws = function(){
    ...
    var worker =  gulp.src('', {read : false}).
        ...
        default: 'west2'
            ...
            var repoTaggedImage = function(_region){
            ...
            worker.pipe(
                shell(
                    [
                        ...
                        'pbpaste;',
                        'docker tag ' + taggedImage + ' ' + repoTaggedImage + ';',
