...
REST.prototype.annotations = function(_annotation){
    var url = BASE_URL+
        '/session/'+_annotation.session+
        '/presentation/'+_annotation.presentation+
        '/slide/'+_annotation.slide+
        '/annotation/';
...
FocalcastApi.prototype.getAnnotations = function(
    ...
    options = this.rest.annotations(_annotation);
...
FocalcastApi.prototype.undoAnnotation = function(_annotation ,success, error){
    options=this.rest.annotations(_annotation);
...
FocalcastApi.prototype.clearAnnotations = function(_annotation,success, error){
    options=this.rest.annotations(_annotation);
