...
class RedisPubSub {
    constructor() {
         ...
         */
        this.redisPub = redis(6379, process.env.REDIS_ADDR, {
            detect_buffers: true,
        ...
        this.redisSub = redis(6379, process.env.REDIS_ADDR, {
            detect_buffers: true,
            return_buffers: false
        });
         ...
         */
        this.ioPub = redis(6379, process.env.REDIS_ADDR, {
            detect_buffers: true,
            return_buffers: false
        });
        ...
        this.ioSub = redis(6379, process.env.REDIS_ADDR, {
            return_buffers: true
        });
